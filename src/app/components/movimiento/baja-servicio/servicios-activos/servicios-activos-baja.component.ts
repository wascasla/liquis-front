...
@Component({
  selector: 'app-servicios-activos-baja',
  templateUrl: './servicios-activos-baja.component.html',
  styleUrls: ['./servicios-activos-baja.component.css']
})
export class ServiciosActivosBajaComponent implements OnInit, OnChanges {
