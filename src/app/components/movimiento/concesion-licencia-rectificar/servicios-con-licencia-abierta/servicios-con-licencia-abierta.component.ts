...
@Component({
  selector: 'app-servicios-con-licencia-abierta',
  templateUrl: './servicios-con-licencia-abierta.component.html',
  styleUrls: ['./servicios-con-licencia-abierta.component.css']
})
export class ServiciosConLicenciaAbiertaComponent implements OnInit, OnChanges {
  ...
  displayedColumns: string[] = ['select', 'IdServicioAgente', 'IdPlaza', 'SubOrganizacion', 'Asignatura',
    'Horas', 'SR', 'SituacionLaboral', 'FechaAlta', 'FechaBaja', 'star'];
  ...
  highlight(element: any, isSelect: boolean) {
